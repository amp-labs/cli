...
// Defines values for FieldsCreatedEventEnabled.
const (
	FieldsCreatedEventEnabledAlways FieldsCreatedEventEnabled = "always"
)
...
// FieldsCreatedEvent Configuration for detecting when new fields are created.
type FieldsCreatedEvent struct {
	// Enabled If always, the integration will monitor for new fields by default.
	Enabled FieldsCreatedEventEnabled `json:"enabled"`
}

// FieldsCreatedEventEnabled If always, the integration will monitor for new fields by default.
type FieldsCreatedEventEnabled string
...
type WatchSchemaAllObjects struct {
	...
	// FieldsCreated Configuration for detecting when new fields are created.
	FieldsCreated *FieldsCreatedEvent `json:"fieldsCreated,omitempty"`
}
