...
func (e UpdateEventWatchFieldsAuto) Valid() bool {
	switch e {
	case UpdateEventWatchFieldsAutoAll:
		return true
	case UpdateEventWatchFieldsAutoSelected:
		return true
	default:
		return false
	}
...
type HydratedIntegration struct {
	// DisplayName Example: Salesforce Accounts
	DisplayName string `json:"displayName,omitempty"`

	// Module Example: crm
	Module string `json:"module,omitempty"`

	// Name Example: readSalesforceAccounts
...
type HydratedIntegrationFieldExistent struct {
	// DisplayName Example: Billing City
	DisplayName string `json:"displayName"`

	// FieldName Example: billingcity
	FieldName string `json:"fieldName"`
